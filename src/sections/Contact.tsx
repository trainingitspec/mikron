      ...
      <div className="max-w-[1400px] mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div ref={leftRef}>
            ...
            >
              Маєте питання щодо наших продуктів? Хочете обговорити корпоративне
              рішення? Наша команда готова допомогти.
            </p>
            ...
            <div className="mt-8 space-y-3">
              ...
              <p className="text-soft font-sans text-[15px] mt-3" style={{ lineHeight: 1.6 }}>
                Київ, вул. Хрещатик 22, БЦ «Гуллівер», офіс 1504
              </p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <input
                    ...
                    required
                    className="w-full bg-[#0a0a0a] border border-charcoal text-white font-sans text-[15px] p-4 focus:border-gold focus:outline-none transition-colors placeholder:text-[#666666]"
                  />
                </div>
                <div>
                  <input
                ...
                <div>
                  <select
                    ...
                    className="w-full bg-[#0a0a0a] border border-charcoal text-white font-sans text-[15px] p-4 focus:border-gold focus:outline-none transition-colors appearance-none cursor-pointer"
                  >
                    <option value="general">Загальне питання</option>
                    <option value="support">Підтримка продуктів</option>
                    <option value="enterprise">Корпоративні рішення</option>
                ...
                <div>
                  <textarea
                    ...
                    rows={5}
                    required
                    className="w-full bg-[#0a0a0a] border border-charcoal text-white font-sans text-[15px] p-4 focus:border-gold focus:outline-none transition-colors resize-none placeholder:text-[#666666]"
                  />
                </div>
                <button
                  type="submit"
